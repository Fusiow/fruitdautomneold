...
*/
/**
 * Boxtale_Envoimoinscher : EnvoiMoinsCher's carrier orders.
 * 
 * @category    Boxtale
...
class Boxtale_Envoimoinscher_Block_Sales_Emc_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{

  public function __construct()
  {
    parent::__construct();
    $this->setId('sales_emc_grid');
  ...
  protected function _prepareCollection()
  {
    ...
    ->joinLeft(array('eo' => $emcOrders), 'eo.sales_flat_order_entity_id  = main_table.entity_id', 
      ...
      'price_transp' => 'price_ttc_eor', 'srv_emc' => 'service_eor', 
      'time_diff' => '(UNIX_TIMESTAMP("'.date('Y-m-d H:i:s').'") - UNIX_TIMESTAMP(date_order_eor))'))
    ->joinLeft(array('eop' => $emcOperators), 'eo.emc_operators_code_eo = eop.code_eo', 
      array('ope_emc' => 'name_eo')) 
    ->joinLeft(array('or' => $salesOrder), 'or.entity_id  = main_table.entity_id', 
      array('entity' => 'entity_id', 'ship_price' => 'shipping_amount', 'label_service' => 'shipping_description'))
    ->joinLeft(array('ed' => $emcDocuments), 'ed.sales_flat_order_entity_id = eo.sales_flat_order_entity_id',
      array('label_state' => 'state_ed'))
    ->joinLeft(array('eoe' => $emcOrdersErrors), 'eoe.sales_flat_order_entity_id = main_table.entity_id', 
      array())
    ->where('or.shipping_method LIKE "envoimoinscher_%" AND eo.ref_emc_eor IS NULL AND eoe.sales_flat_order_entity_id IS NULL AND or.state NOT IN("canceled", "fraud", "holded", "closed", "complete") ')
  ...
  protected function _prepareMassaction()
  {
    ...
    'url'  => $this->getUrl('envoimoinscher/sales/init', array("type" => "normal")),
    ));
    return $this;
  }
  ...
  {
    return $this->getUrl('envoimoinscher/sales/index', array('_current'=>true, "source" => "emc"));
  }
