...
class Boxtale_Envoimoinscher_Block_Sales_Errors_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{

  public function __construct()
  {
    parent::__construct();
    $this->setId('sales_errors_grid');
  ...
  protected function _prepareCollection()
  {
    ...
    ->join(array('eoe' => $emcOrdersErrors), 'eoe.sales_flat_order_entity_id = main_table.entity_id',
      array('error_message' => 'errors_eoe'))
  ...
  protected function _prepareMassaction()
  {
    ...
    'url'  => $this->getUrl('envoimoinscher/sales/init', array("type" => "forceCheck", "source" => "errors")),
    ));
    return $this;
  }
